...
export const getUnifiedRestaurantContent = async (req: Request, res: Response) => {
  try {
    ...
    res.status(500).json({ message: 'Error fetching unified content', error });
  }
}; 